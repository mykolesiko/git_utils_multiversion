...
def plot_mean_roc(rocs, auto_flip=True, show_all=False, ax=None, multi = None, **kwargs):
    """
    ...
    # Compute average ROC.
    print(f"show_ti = {show_ti}")
    print(f"show_ci = {show_ci}")
...
def plot_roc_bootstrap(X, y, pos_label = 1, 
